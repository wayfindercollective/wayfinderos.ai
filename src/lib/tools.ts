...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    desc: "Branded checkout and SKU management on Stripe + QuickBooks - saved cards, subscriptions, payment plans and failed-payment alerts, wired to the same CRM and analytics as everything else.",
  ...
  },
  {
    ...
    desc: "Audience segmentation, campaigns, tracking and analytics.",
...
export const EXTRAS: Tool[] = [
  ...
  },
  {
    ...
    desc: "Full P&L with forward projections, sales attribution, funnel health, speed-to-lead and margin analysis - fed by a live bank-feed (Mercury / Stripe) so the numbers reconcile themselves.",
...
export const AI_POINTS = [
  { t: "Email drafting", d: "Replies and campaigns drafted in each coach's own voice.", svg: '<path d="m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7"/><rect x="2" y="4" width="20" height="16" rx="2"/>' },
  { t: "Lead scoring", d: "Every form, call and webchat scored so reps work the hottest leads first.", svg: '<circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/>' },
  ...
  { t: "Buyer personas", d: "Generated from your real pipeline, not a generic template.", svg: '<circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 0 0-16 0"/>' },
  { t: "Upsell briefs", d: "The next best offer for each customer, written for you.", svg: '<path d="M16 7h6v6"/><path d="m22 7-8.5 8.5-5-5L2 17"/>' },
  { t: "Voice campaigns", d: "Outbound that dials and qualifies leads automatically.", svg: '<path d="M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 6.392 6.384"/>' },
];
